...
export const LinesChartDirective = ($compile, $timeout) => ({
    restrict: 'A',
    link(scope, element) {
        scope.$watch('$ctrl.lineChartData', function () {
            ...
            // Adds the svg canvas
            var svg = d3.select("#chart_ocurrences_line").append("svg")
            ...
            gradient.append("stop")
                .attr('class', 'start')
                .attr("offset", "0%")
                .attr("stop-color", scope.$ctrl.AvColors[scope.$ctrl.attackIndex])
                .attr("stop-opacity", 1);
            ...
            svg.selectAll("dot")
                ...
                .enter().append("circle")
                .attr("r", 5)
                .attr("fill", scope.$ctrl.AvColors[scope.$ctrl.attackIndex])
...
export default LinesChartDirective;
