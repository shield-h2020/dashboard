    ...
    scope.$watch("$ctrl.donutChartData", function() {
      ...
      if (scope.$ctrl.attackIndex === -1)
        ...
        for (let j = 0; j < nrSeries; j += 1) {
          ...
          else grayedColors[j] = scope.$ctrl.AvColors[j];
        }
        ...
        slice
          ...
          .on("click", (d, i) => {
            if (scope.$ctrl.attackIndex === i) {
              ...
              var selectedAttack = d.data.name.substring(
                0,
                d.data.name.indexOf("-") - 1
              );
        ...
        const legend = svg
          ...
          .attr({
            ...
            transform(d, i) {
              ...
              if (i >= 4) {
                return `translate(${(i - 4) * legendHeight -
                  25 * nrSeries},230)`;
              } else {
